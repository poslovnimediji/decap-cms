...
import { KEYS, ExitBreakPlugin, TrailingBlockPlugin } from 'platejs';
import { usePlateEditor, Plate, ParagraphPlugin, PlateLeaf, PlateContainer } from 'platejs/react';
import {
  BoldPlugin,
  ItalicPlugin,
  CodePlugin,
...
export default function VisualEditor(props) {
  ...
  const editor = usePlateEditor({
    ...
    plugins: [
      ...
      //   rules: { break: { emptyLineEnd: 'deleteExit' }, delete: { emptyLineEnd: 'deleteExit' } },
      // }),
      // BoldPlugin,
      // ItalicPlugin,
      // CodePlugin,
      ...
      //       //     start: true,
      //       //     end: true,
      //       //     allow: [KEYS.h1, KEYS.h2, KEYS.h3, KEYS.h4, KEYS.h5, KEYS.h6],
      //       //   },
      //       //   relative: true,
      //       //   level: 1,
      //       // },
